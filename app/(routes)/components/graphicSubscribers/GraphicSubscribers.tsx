...
import { dataGraphic } from "./GraphicSubscribers.data";

export default function GraphicSubscribers() {
  return (
    <div className="mt-5">
      <p className="text-3xl mb-3">1234</p>
      <div className="flex gap-x-5 mb-5">
        <div className="flex items-center gap-2 px-3 text-sm bg-[#16c8c7] text-white rounded-xl w-fit">
          8.5%
